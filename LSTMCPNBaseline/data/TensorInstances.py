...
class TrainTensorInstances:
    def __init__(self, batch_size, slen, tlen, repr_dim):
    ...
    @property
    def inputs(self):
        return self.src_words, self.src_reprs, self.src_masks, self.tgt_words, self.tgt_reprs, self.tgt_masks
