...
class Configurable(object):
    ...
    @property
    def pretrained_repr_file(self):
        return self._config.get('Data', 'pretrained_repr_file')
    ...
    @property
    def code_file(self):
        return self._config.get('Data', 'code_file')
    ...
    @property
    def code_batch_size(self):
        return self._config.getint('Run', 'code_batch_size')
    ...
    def display_interval(self):
        return self._config.getint('Run', 'display_interval')

    @property
    def code_display_interval(self):
        return self._config.getint('Run', 'code_display_interval')
