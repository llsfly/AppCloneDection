...
class Configurable(object):
    ...
    @property
    def pretrained_token_file(self):
        return self._config.get('Data', 'pretrained_token_file')

    @property
    def pretrained_word_file(self):
        return self._config.get('Data', 'pretrained_word_file')
    ...
    @property
    def token_dims(self):
        return self._config.getint('Network', 'token_dims')
    ...
    @property
    def neg_count(self):
        return self._config.getint('Optimizer', 'neg_count')

    @property
    def loss_margin(self):
        return self._config.getfloat('Optimizer', 'loss_margin')
